...
void main() {
  ...
  group('QRValidationResultExtension Tests', () {
    ...
    test('userMessage retourne un message par défaut si pas d\'erreur spécifiée', () {
      final result = QRValidationResult._(isValid: false);
      expect(result.userMessage, equals('Invalid QR code'));
    });
